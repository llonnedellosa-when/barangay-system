...
const NAV = [
    ...
    },
    {
        label: "Records",
        items: [
            { href: "/documents", icon: "📄", label: "Document Requests" },
            { href: "/documents/create", icon: "➕", label: "New Request" },
        ],
    },
    {
        label: "Cases",
        items: [
            { href: "/blotter", icon: "⚖️", label: "Blotter Reports" },
            { href: "/blotter/create", icon: "🚨", label: "File Blotter" },
        ],
    },
];
            ...
            <style>{`
                ...
                * { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .bims-nav-label {
                    ...
                    color: rgba(255,255,255,.35); padding: 18px 24px 6px;
                }
                .bims-nav-link {
                ...
                .bims-nav-link.active { background: rgba(255,255,255,.07); color: #fff; border-left-color: #f0b429; }
                ...
                .bims-btn-danger  { background: #c0392b; color: #fff; box-shadow: 0 3px 12px rgba(192,57,43,.25); }
